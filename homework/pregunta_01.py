...
def pregunta_01():
    ...
    * Su código debe crear la carpeta `docs` si no existe.
    ...
    def creat_visual_for_shipping_per_warehouse(df):
        df = df.copy()
        plt.figure()
    ...
    def creat_visual_for_mode_of_shipment(df):
        df = df.copy()
        plt.figure()
    ...
    def create_visual_for_average_customer_rating(df):
        ...
        plt.title("Average Coustomer Rating")
    ...
    df = load_data()
    creat_visual_for_shipping_per_warehouse(df)
    creat_visual_for_mode_of_shipment(df)
